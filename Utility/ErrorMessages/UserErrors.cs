namespace Utility.ErrorMessages
{
    public static class UserErrors
    {
        ...
        public static readonly string FirstName = "First Name should have between 3 and 100 alphanumeric characters, including '-' and ' '";
        public static readonly string LastName = "Last Name should have between 3 and 100 alphanumeric characters, including '-' and ' '";
